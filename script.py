...
element.send_keys("rishabhojha741@proton.me")
...
passw.send_keys("Goldu@741")
passw.send_keys(Keys.ENTER)
time.sleep(3)

telegram_bot_sendtext("Logged-CS")
...
while True:
    try:
        ...
        if limit_text != "https://expert.chegg.com/qna/authoring/answer":
           ...
           telegram_bot_sendques("LIMIT HIT FOR THE DAY IN CSrisb")
           time.sleep(n)
        driver.get("https://expert.chegg.com/qna/authoring/answer")
        time.sleep(5)
        ...
        if text_to_copy == "Thank you for your efforts on Chegg Q&A! Unfortunately, no Qs are available in your queue at the moment.":
            ...
            telegram_bot_sendques("Question in CSrisb")
            time.sleep(720)
    except Exception as e:
        telegram_bot_sendtext("An error occurred in CSrizb ")
# Quit the WebDriver
driver.quit()
